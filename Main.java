...
public class Main {
    public static void main(String[] args) {
        Zoo zoopark = new Zoo();
        zoopark.addAnimals(List.of(new Cat("Barsik"), new Dog("Sharik"), new Rabbit("Whik"), new Cow("Murka"), new Duck("Krya"), new Butterfly("Yellow"), new Fish("Fishka")));
        ...
        System.out.println("---------------------------------------------");
        for (Swimming item : zoopark.getSwimming()){
            System.out.println(item);
        }
    }
}
